## Development Environment Standardization Guide
...
```shell
$ git clone https://github.com/18F/dev-environment-standardization.git
$ cd dev-environment-standardization
$ ./go serve
```
...
The [Guides Template](https://pages.18f.gov/guides-template/)) will walk you
...
`https://pages-staging.18f.gov/dev-environment-standardization`, which is
